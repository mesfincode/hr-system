  ...
  return (
    <>
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" className="w-[160px] bg-gray hover:text-black " >
          <DropdownMenuItem
            onClick={() => router.push(`/employees/${employee?.id}`)} className="hover:cursor-pointer"
          >
            View
          </DropdownMenuItem>
          <DropdownMenuItem onClick={() => setUpdateOpen(true)} className="hover:cursor-pointer">
            Update
          </DropdownMenuItem>
          <DropdownMenuSeparator />
